...
def run(data, fltrs_out, l2_reg, lr, epochs, batch_size, val_size, test_size, seed=0, es_patience=20,
        model_logdir=None, num_examples=50000, model_name=None, pretrain_path=None):
    """
...
# PC Local paths
model_logdir = r"C:\Users\xmoot\Desktop\Models\TensorFlow\ssl-seizure-detection\models\supervised\rp_transfer"
data_path = r"C:\Users\xmoot\Desktop\Data\ssl-seizure-detection\patient_gr\jh101_grs.pickle"
pretrain_path = r"C:\Users\xmoot\Desktop\Models\TensorFlow\ssl-seizure-detection\models\relative_positioning\jh101_12s_7min_200epochs_12000examples\jh101_12s_7min_200epochs_12000examples.h5"
...
es_patience=20
num_examples=4484
model_name = "jh101_12s_7min" + str(epochs) + "epochs_" + str(num_examples) + "examples"
...
run(data=data, fltrs_out=fltrs_out, l2_reg=l2_reg, lr=lr, epochs=epochs, batch_size=batch_size, val_size=val_size, test_size=test_size,
    seed=seed, es_patience=es_patience, model_logdir=model_logdir, num_examples=num_examples, model_name=model_name, pretrain_path=pretrain_path)
