...
def patch(graphrep_dir=None, logdir=None, file_name=None, num_electrodes=107, tau_pos=12//0.1, tau_neg=(7 * 60) // 0.12,
          mode="binary", model="supervised", stats=True):
  ...
  if mode == "binary":
    ...
    pyg_grs = create_tensordata(num_nodes=num_electrodes, data_list=pickle_data, complete=True, save=False, logdir=None, mode="multi")
